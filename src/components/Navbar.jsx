    ...
    <>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 font-body text-sm text-light/80">
            ...
            <Link to="/about#leadership" className="hover:text-accent transition-colors hover:-translate-y-[1px] transform">Leadership</Link>
          </div>
      ...
      <div className={`fixed inset-0 bg-dark z-[100] transition-opacity duration-300 ${mobileMenuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
        ...
        <div className="flex flex-col items-center justify-start pt-24 pb-20 min-h-full gap-8 font-heading text-xl font-semibold overflow-y-auto w-full">
          ...
          <Link to="/about#leadership" onClick={() => setMobileMenuOpen(false)} className="hover:text-accent text-3xl">Leadership</Link>
