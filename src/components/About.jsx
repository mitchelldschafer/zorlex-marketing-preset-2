  ...
  return (
    <div ref={container} className="min-h-screen bg-dark pt-28 md:pt-40 pb-16 md:pb-32 px-4 sm:px-6">
      <div className="max-w-[1320px] mx-auto">
        ...
        {/* Header Section */}
        <div className="about-header mb-12 md:mb-24 max-w-[800px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
          <div className="about-grid-item p-7 sm:p-10 md:p-12 bg-dark-surface rounded-[28px] md:rounded-[40px] border border-white/5 group hover:border-accent/30 transition-all duration-500">
            <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-accent/10 flex items-center justify-center mb-6 md:mb-8 group-hover:scale-110 transition-transform duration-500">
              <Target className="text-accent" size={28} />
            </div>
            <h3 className="text-2xl md:text-3xl font-heading font-semibold text-white mb-4 md:mb-6">Our Mission</h3>
          ...
          <div className="about-grid-item p-7 sm:p-10 md:p-12 bg-dark-surface rounded-[28px] md:rounded-[40px] border border-white/5 group hover:border-accent/30 transition-all duration-500">
            ...
            <h3 className="text-2xl md:text-3xl font-heading font-semibold text-white mb-4 md:mb-6">Our Philosophy</h3>
            <p className="text-base md:text-lg text-white/60 leading-relaxed font-body">
          ...
          <div className="about-grid-item p-7 sm:p-10 md:p-12 bg-dark-surface rounded-[28px] md:rounded-[40px] border border-white/5 group hover:border-accent/30 transition-all duration-500">
            ...
            <h3 className="text-2xl md:text-3xl font-heading font-semibold text-white mb-4 md:mb-6">Technical Edge</h3>
            <p className="text-base md:text-lg text-white/60 leading-relaxed font-body">
          ...
          <div className="about-grid-item p-7 sm:p-10 md:p-12 bg-dark-surface rounded-[28px] md:rounded-[40px] border border-white/5 group hover:border-accent/30 transition-all duration-500">
            ...
            <h3 className="text-2xl md:text-3xl font-heading font-semibold text-white mb-4 md:mb-6">Built for Trust</h3>
            <p className="text-base md:text-lg text-white/60 leading-relaxed font-body">
