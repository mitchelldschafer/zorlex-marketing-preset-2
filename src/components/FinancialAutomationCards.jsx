...
export default function FinancialAutomationCards() {
  ...
  return (
    <div ref={container} className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
      {cards.map((card, i) => (
        <div key={i} className="fin-card opacity-0 bg-dark-surface p-10 rounded-[32px] border border-white/5 hover:border-accent/30 transition-all duration-500 group">
